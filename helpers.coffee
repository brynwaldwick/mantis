...
buildGrid = (bounds, n_grid=5) ->
    ...
    # Low to high
    lat_tics = divideByN lat2, lat1, n_grid
    lng_tics = divideByN lng1, lng2, n_grid
...
_buildGrid = (bounds, scrape_radius) ->
    return {bounds, scrape_radius}
